    ...
    tokenized_path: Optional[str] = field(
        ...
        metadata={
            "help": (
                ...
                "IMPORTANT: you may provide a comma-separated string of multiple paths ONLY when loading existing datasets. "
                "When saving (tokenized_path does not exist), only a single path is allowed and will raise an error if multiple paths are provided."
            )
        },
    )
