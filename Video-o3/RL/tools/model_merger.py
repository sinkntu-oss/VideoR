...
if __name__ == '__main__':
    ...
    parser.add_argument('--local_dir', default="/root/s3/videogpu/videochat-o3/ckpt/GRPO-Video-20251125-2258/global_step_150/actor", type = str, help="The path for your saved model")
