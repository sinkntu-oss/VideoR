...
class MultiModalDatasetVideo(Dataset):
    ...
    def __init__(self,
        ...
        print("self.use_scene_detection（场景检测）:", self.use_scene_detection)
    ...
    def __getitem__(self, item):
        ...
        if self.video_key in row_dict:  # 扩展视频令牌
            ...
            try:
                ...
                if self.use_scene_detection:
                    ...
                    video_tensor, sample_fps, raw_video_tensor, raw_sample_fps, scene_boundaries = process_video_adaptive_token_num_with_scenes(
                    ...
                    row_dict['scene_boundaries'] = scene_boundaries
                else:
